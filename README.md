...
| Item | Type | Purpose |
|------|------|---------|
| `skills/wp-compliance` | Claude Code skill | Enforces 34 WordPress security rules + Plugin Check review workflow + PHPCS suppression playbook before any WP coding task |
